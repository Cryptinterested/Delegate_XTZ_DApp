...
function getAddressFromPublicKey(publicKey) {
    return __awaiter(this, void 0, void 0, function () {
        var plainPublicKey, edpkPrefixLength, decoded, payload, tz1Prefix;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sodium.ready];
                case 1:
                    ...
                    tz1Prefix = Buffer.from(new Uint8Array([6, 161, 159]));
                    return [2 /*return*/, bs58check.encode(Buffer.concat([tz1Prefix, Buffer.from(payload)]))];
            }
        });
    });
}
